...
import 'components/personal_info_bar.dart';
import 'helpers.dart';
...
class SteppersForClinicOwners extends StatelessWidget {
  const SteppersForClinicOwners({super.key});
      ...
      Step(
        ...
        content: Container(
            ...
            child: PersonalInfoNameBar(
              methodToRun: _firestore_database_service.updateMajorInfo,
              controller: _controllerForMajorInfo,
              label:
                  "What's your major? A doctor? Maybe a Plastic Surgery Expert? .)",
              lineCount: 1,
            )),
      ),
      Step(
        ...
        content: Container(
            alignment: Alignment.centerLeft,
            child: PersonalInfoNameBar(
              methodToRun: _firestore_database_service.updateClinicName,
              controller: _controllerForClinicName,
              label: "What's the name of the clinic you are working on?",
              lineCount: 1,
            )),
      ),
      Step(
        ...
        content: Container(
            alignment: Alignment.centerLeft,
            child: PersonalInfoNameBar(
              methodToRun: _firestore_database_service.updateClinicLocation,
              controller: _controllerForClinicLocation,
              label: "Where is your clinic based on?",
              lineCount: 1,
            )),
      ),
      Step(
        ...
        content: Container(
            alignment: Alignment.centerLeft,
            child: PersonalInfoNameBar(
              methodToRun: _firestore_database_service.updateBiography,
              controller: _controllerForBiography,
              label: "Tell the people about you",
              lineCount: 4,
            )),
      ),
    ];
